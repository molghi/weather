...
const WeatherDaily = () => {
    ...
    return (
            ...
            <div>
                ...
                <div className="flex items-stretch justify-center gap-[30px]">
                    ...
                    {Array.from({ length: 3 }, (_, i) => nowIndexDaily + 1 + i).map((x, i) => (
                        <div
                            key={i}
                            className="flex flex-col flex-[1_1_33.3333333333%] transition-all duration-300 p-[10px] rounded-[10px] leading-[1] shadow-[inset_0_0_1px_white] hover:bg-white/10 hover:scale-110 transition-transform"
                        >
                            {/* DAY IT IS */}
                            <div className="mb-[5px] opacity-50">
                                {dayNames[i]} ({new Date(weather?.daily.time[x]).getDate()}/
                                {(new Date(weather?.daily.time[x]).getMonth() + 1).toString().padStart(2, "0")}/
                                {new Date(weather?.daily.time[x]).getFullYear().toString().slice(2)})
                            </div>

                            {/* AIR TEMP */}
                            <div className="mb-[5px] cursor-pointer" onClick={() => console.log(`perform C/F conversion`)}>
                                {Math.round(weather?.daily.temperature_2m_min[x])} -{" "}
                                {Math.round(weather?.daily.temperature_2m_max[x])}°C &nbsp;
                                <span className="opacity-50" title="Feels like">
                                    ({Math.round(weather?.daily.apparent_temperature_min[x])} -{" "}
                                    {Math.round(weather?.daily.apparent_temperature_max[x])}°C)
                                </span>
                            </div>
       ...
       [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:2]"
                            ...
                            >
                                {interpretWeathercode(weather?.daily.weather_code[x])}
                            </div>
                            ...
                            <div className="flex items-center gap-[30px] mb-[5px] translate-x-[17px]">
                                ...
                                <div className="flex items-center gap-[10px] leading-[1]" title="UV index">
                                    ...
                                    {weather?.daily.uv_index_max[x].toFixed(1)}
                                </div>

                                {/* DAYLIGHT DURATION */}
                                <span className="whitespace-nowrap flex items-center gap-[10px]" title="Daylight duration">
                                    <span className="max-w-[15px] w-[15px]">
                                        <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                    ...
                                    <span className="max-w-[20px] w-[20px]">
                                        ...
                                        >
                                            ...
                                            <g>
                                                <path
                                                    className="st0"
                                                    d="M465.4,278.465c6.7-4.666,15.913-9.487,27.562-14.41l19.033-8.06l-19.033-8.059
		...
		c84.133,0,152.352-68.211,152.352-152.352C408.352,171.854,340.133,103.645,256,103.645z"
                            ...
                            <div className="mb-[5px] flex items-center gap-[30px]">
                                ...
                                <span className="whitespace-nowrap flex items-center gap-[10px]" title="Sunrise">
                                    ...
                                    {weather?.daily.sunrise[x].slice(-5)}
                                </span>
                                ...
                                <span className="whitespace-nowrap flex items-center gap-[10px]" title="Sunset">
                                    ...
                                    {weather?.daily.sunset[x].slice(-5)}
                                </span>
                            </div>

                            {/* PRECIPITATION */}
                            <div
                                className="flex items-center justify-start gap-[10px] flex-initial"
                            ...
                            >
                                ...
                                {weather?.daily.precipitation_probability_max[x]}%
                            </div>
                        </div>
                    ))}
                </div>
