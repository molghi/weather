const BottomRight = () => {
    return (
        <div>
            {/* CHANGE LOCATION */}
            <button className="absolute bottom-[10px] right-[10px] border border-white p-[10px] opacity-20 transition-all duration-300 hover:bg-white hover:opacity-100 hover:text-black hover:shadow-[0_0_7px_white]">
                Change Location
            </button>
