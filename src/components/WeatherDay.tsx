...
const sunshineIcon = (
    <svg className="fill-white" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
const sunriseIcon = (
    <svg className="fill-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
const sunsetIcon = (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-white">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M4.25 19C4.25 18.5858 4.58579 18.25 5 18.25H19C19.4142 18.25 19.75 18.5858 19.75 19C19.75 19.4142 19.4142 19.75 19 19.75H5C4.58579 19.75 4.25 19.4142 4.25 19ZM7.25 22C7.25 21.5858 7.58579 21.25 8 21.25H16C16.4142 21.25 16.75 21.5858 16.75 22C16.75 22.4142 16.4142 22.75 16 22.75H8C7.58579 22.75 7.25 22.4142 7.25 22Z"
...
const WeatherDay = ({ index, dayIndex }: WeatherDayProps) => {
    ...
    const { weather, formatDuration, tempUnits, setTempUnits } = context;

    const [weatherMainMin, setWeatherMainMin] = useState<number>(0);
    const [weatherMainMax, setWeatherMainMax] = useState<number>(0);
    const [weatherFeelsLikeMin, setWeatherFeelsLikeMin] = useState<number>(0);
    const [weatherFeelsLikeMax, setWeatherFeelsLikeMax] = useState<number>(0);
    ...
    return (
        <div className="flex flex-col flex-[1_1_33.3333333333%] transition-all duration-300 p-[10px] rounded-[10px] leading-[1] shadow-[inset_0_0_1px_white] hover:bg-white/10 hover:scale-110 transition-transform hover:backdrop-blur-sm">
            {/* DAY IT IS */}
            ...
            >
                {weatherMainMin} - {weatherMainMax}
                {tempSign} &nbsp;
                <span className="opacity-50" title="Feels like">
                    ({weatherFeelsLikeMin} - {weatherFeelsLikeMax}
                    {tempSign})
                </span>
            </div>
